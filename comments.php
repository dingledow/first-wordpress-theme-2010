...
<?php if ( have_comments() ) : ?>
	...
	<ol class="commentlist">
        ...
        <li id="comment-<?php comment_ID(); ?>">  
            ...
            <div class="commenttext"><div class="commentinfo"><?php comment_type(); ?> by <?php comment_author_link(); ?> on <?php comment_date(); ?> at <?php comment_time(); ?></div><?php comment_text(); ?></div>
